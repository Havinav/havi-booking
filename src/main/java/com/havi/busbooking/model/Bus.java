...
public class Bus {
	...
	public Bus(String busName, String busNo, String busType, String source, String destination, String startTime,
			String endTime, String arrivalTime, Double price, String rating, String amenities,
			LocalDateTime busStartDate, LocalDateTime busEndDate, LocalDateTime tripDate) {
	...
	// Helper method to add a seat (modifies existing collection)
	...
	// Helper method to remove a seat (modifies existing collection)
	...
	public void setSeats(List<Seat> seats) {
		if (seats == null) {
			...
			seats.forEach(seat -> seat.setBus(this));
		}
	}
}